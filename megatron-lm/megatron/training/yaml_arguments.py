...
from megatron.core.utils import get_torch_version, init_method_kaiming_normal, init_method_normal, is_torch_min_version
...
def core_transformer_config_from_yaml(args, transfomer_key = "language_model"):    
    ...
    if args.init_method == "kaiming_normal":
        kw_args['init_method'] = init_method_kaiming_normal()
        kw_args['output_layer_init_method'] = init_method_kaiming_normal()
        emb_std = getattr(args, 'embedding_init_method_std', None) or args.init_method_std
