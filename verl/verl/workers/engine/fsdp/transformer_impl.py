...
from verl.custom_optimizer.pion import (
...
from .utils import coerce_fsdp_use_orig_params, create_device_mesh, get_sharding_strategy
...
class FSDPEngine(BaseEngine):
    ...
    def _build_optimizer(self, module):
        ...
        prepare_pion_module_tags(
            module,
            optimizer_name=str(getattr(oc, "optimizer", "") or ""),
            override_optimizer_config=getattr(oc, "override_optimizer_config", None),
        )
